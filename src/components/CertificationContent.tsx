...
export function CertificationContent() {
    ...
    const alreadyPurchased = hasAccess ? hasAccess("caio") : false;
    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 text-white py-16 lg:py-24">
                <div className="container">
                    <div className="max-w-3xl mx-auto text-center">
                        <p className="text-gold-400 font-semibold mb-4">AI ESSENTIALS BUNDLE</p>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <div>
                                ...
                                <p className="text-navy-600">
                                    This course bundle covers everything you need to use AI confidently and safely.
                                </p>
                            </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="card sticky top-24">
                                <h3 className="text-h2 text-navy-800 mb-2">AI Essentials Bundle</h3>
                                <p className="text-3xl font-bold text-navy-900 mb-4">$197</p>

                                <ul className="space-y-3 mb-6">
                                    <li className="flex items-center gap-3">
                                        <BookOpen className="w-5 h-5 text-gold-600" />
                                        <span className="text-navy-600">11 comprehensive video lessons</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <Clock className="w-5 h-5 text-gold-600" />
                                        <span className="text-navy-600">Self-paced — learn on your schedule</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <Shield className="w-5 h-5 text-gold-600" />
                                        <span className="text-navy-600">AI safety and security training</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <Award className="w-5 h-5 text-gold-600" />
                                        <span className="text-navy-600">Certificate of completion</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <Users className="w-5 h-5 text-gold-600" />
                                        <span className="text-navy-600">Access to community Q&amp;A</span>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <Star className="w-5 h-5 text-gold-600" />
                                        <span className="text-navy-600">Lifetime access to updates</span>
                                    </li>
                                </ul>

                                {alreadyPurchased ? (
                                    <Link href="/dashboard/courses/essentials" className="btn btn-primary w-full text-lg">
                                        Go to Course
            ...
            <section className="bg-navy-50 py-16">
                <div className="container">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="space-y-4">
                            <div className="card">
                                <h3 className="font-semibold text-navy-800 mb-2">Do I need any technical experience?</h3>
                                <p className="text-navy-600">Not at all! This course is designed specifically for beginners. We explain everything in plain English with step-by-step instructions.</p>
                            </div>
                            <div className="card">
                                <h3 className="font-semibold text-navy-800 mb-2">How long do I have access?</h3>
                                <p className="text-navy-600">You get lifetime access to the course and all future updates. Learn at your own pace — there&apos;s no rush.</p>
                            </div>
                            <div className="card">
                                <h3 className="font-semibold text-navy-800 mb-2">What if I get stuck?</h3>
                                <p className="text-navy-600">You&apos;ll have access to our community Q&amp;A where you can ask questions and get help from other students and our team.</p>
                            </div>
                            <div className="card">
                                <h3 className="font-semibold text-navy-800 mb-2">Is there a money-back guarantee?</h3>
                                <p className="text-navy-600">Yes! If you&apos;re not satisfied within 30 days, we&apos;ll give you a full refund, no questions asked.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Upgrade to Business Builder */}
            <section className="py-16">
                <div className="container">
                    <div className="max-w-3xl mx-auto">
                        <div className="card bg-navy-800 text-white text-center">
                            <h2 className="text-h2 mb-4">Want to Start a Business?</h2>
                            <p className="text-navy-200 mb-6">
                                Upgrade to our AI Business Builder bundle and get 3 AI tools to help you
                                turn your experience into a profitable consulting business.
                            </p>
                            <Link href="/launchpad" className="btn bg-gold-500 text-navy-900 hover:bg-gold-400">
                                Learn About AI Business Builder — $497
                                <ArrowRight className="w-5 h-5" />
                            </Link>
                        </div>
                    </div>
